...
void CG_Mesh::SetData(float* p_vertexBuffer, YK_U32 p_vertexBufferCount, YK_U32* p_indexBuffer, YK_U32 p_indexBufferCount)
{
...
void CG_Mesh::UploadGPUDataImpl()
{
	m_glData = new CG_GLMeshBuffer(*this);
}

void CG_Mesh::FlushGPUDataImpl()
{
