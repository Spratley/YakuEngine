...
namespace YK_Matrix
{
	...
	YK_Matrix_R_C<DataType, 4, 4> Perspective(DataType p_fov, DataType p_aspectRatio, DataType p_nearPlane, DataType p_farPlane)
	{
		YK_Matrix_R_C<DataType, 4, 4> result(0);
